...
public class ActivityNotificationDetail extends AppCompatActivity {
    ...
    private void requestPostData() {
        this.callbackCall = RestAdapter.createAPI().getVideoDetail(str_vid);
            ...
            if (Tools.isNetworkAvailable(ActivityNotificationDetail.this)) {
                ...
                if (post.video_type != null && post.video_type.equals("youtube")) {
                    ...
                    if (post.video_url != null && post.video_url.startsWith("rtmp://")) {
                        Intent intent = new Intent(ActivityNotificationDetail.this, ActivityRtmpPlayer.class);
        ...
        broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                if (intent.getAction().equals(Constant.PUSH_NOTIFICATION)) {
                    NotificationUtils.showDialogNotification(ActivityNotificationDetail.this, intent);
                }
            }
        };
    }
